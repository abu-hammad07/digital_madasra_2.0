        ...
        <div class="card w-100 overflow-hidden">
          <div class="card-body py-3">
            <div class="row justify-content-between align-items-center">
              <h3 class="mb-9 jameel-kasheeda text-primary">خوش آمدید<span class="mx-1">🎉</span><span>عمرراہی </span>صاحب</h3>
          ...
          <div class="p-3 border-top scroll-bar">
            <div class="d-flex align-items-center pb-2">
              <div class="flex-shrink-0">
                <img src="../assets/images/template/student.png" width="43" class="rounded-circle bg-light-secondary" alt="logo" />
              </div>
      ...
      <div class="col-lg-4">
        <div class="card earning-widget">
          ...
          <div class="p-3 border-top scroll-bar">
            <div class="d-flex align-items-center pb-2">
              <div class="flex-shrink-0">
                <img src="../assets/images/template/female_student.png" width="43" class="rounded-circle bg-light-secondary" alt="logo" />
              </div>
              <div class="ms-2 font-weight-medium">
      ...
      <div class="col-lg-4">
        <div class="card earning-widget">
          ...
          <div class="p-3 border-top scroll-bar">
            <div class="d-flex align-items-center pb-2">
              <div class="flex-shrink-0">
                <img src="../assets/images/template/store.png" width="40" class="rounded-circle bg-light-secondary" alt="logo" />
              </div>
              <div class="ms-2 font-weight-medium">
